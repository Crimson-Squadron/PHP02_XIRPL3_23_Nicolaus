<?php
    ...
    if(isset($_POST['aksi'])){
        if($_POST['aksi'] == "add"){
            ...
            $query = "INSERT INTO buku VALUES(null, '$judul', '$penulis', '$jenis', '$sampul')";
            ...
            $showQuery = "SELECT * FROM buku WHERE id_buku = '$id_buku';";
            ...
            $queryy = "UPDATE buku SET judul_buku='$judul', penulis='$penulis', jenis_buku='$jenis', gambar_buku='$foto' WHERE id_buku='$id_buku';";
